...
#     refresh = input("Souhaitez-vous rafraîchir votre phrase. Oui ou Non ?")
#     if refresh == "Oui" or "oui":
#         J1ListGenerator()
...
# while cmpt > 20:
    # cmpt += 1
    # print("Tour", cmpt)
    # print("Liste principale :",Liste10Mots)
    # print("Liste Joueur 1 :",J1Liste2Mots)
    # ChoixJ1()
    # print("Tour du joueur 2")
    # print("Liste principale :",Liste10Mots)
    # print("Liste Joueur 2 :",J2Liste2Mots)
    # ChoixJ2()
# Régler le problème des choix et raccorder TOUTES les fonctions entre elles
